 ...
 * 
 * CredentialStore owns Bloom's provider-neutral service and account-key schema.
 */
class ISecretStore {
public:
     ...
     * @param service Service identifier (for example, "Bloom/Connections")
     * @param account Opaque account identifier generated by CredentialStore
